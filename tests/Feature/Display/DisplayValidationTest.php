...
class DisplayValidationTest extends TestCase
{
     ...
     * @test
     *
     * @dataProvider invalidCreateDisplays
     */
     ...
     * @test
     *
     * @dataProvider invalidUpdateDisplays
     */
    ...
    public function invalidUpdateDisplays(): array
    {
        $display_data = [
      ...
      public function invalidCreateDisplays(): array
      {
          $display_data = [
              'name' => 'teste', 'size' => 42, 'width' => 1920, 'height' => 1080, 'observation' => 'a', 'pairing_code' => 'aaaaaa',
          ];
