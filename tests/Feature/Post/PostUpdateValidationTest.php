...
class PostUpdateValidationTest extends TestCase
{
  ...
  public function end_date_can_be_same_as_start_date()
  {
    ...
    $this->postJson(route('posts.update'),
  ...
  public function start_date_and_end_date_must_not_be_passed_even_as_null_if_recurrence_id_is_present()
  {
    ...
    $this->postJson(route('posts.update'), $post_data)
      ->assertUnprocessable()
   ...
   */
  public function cant_update_invalid_post($invalidData, $invalidFields)
  {

    $response = $this->postJson(route('posts.update'), $invalidData);
